...
export declare class UserType {
   ...
   */
  create_subAccount(email: string, firstname: string, lastname: string, phone_number: string): Promise<any | undefined>;

  /**
   * Fetch all sub account
   * @returns {Promise<any | undefined>}
   */
  fetch_all_subAccounts(): Promise<any | undefined>;
...
export declare class WalletsType {
   ...
   * @returns {Promise<any | undefined>}
   */
  fetch_payment_addresses(userId: string, currency: string): Promise<any | undefined>;
   ...
   * @returns {Promise<any | undefined>}
   */
  fetch_payment_address(userId: string, currency: string): Promise<any | undefined>;
...
declare class Markets {
   ...
   * @returns {Promise<any | undefined>} The response
   */
  fetchKLineDataWithPendingTradesForAMarket(
    market: string,
    limit: string,
    period: string,
    timestamp: string,
